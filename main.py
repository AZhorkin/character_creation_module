...
def attack(char_name: str, char_class: str) -> str:
    """Атака, выбор случайных значений."""
...
def defence(char_name: str, char_class: str) -> str:
    """Блокиновка атаки,выбор случайных значений."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Суперсила, выбор случайных значений."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Определяет действие с передачей параметра в соответствующие функции.
...
def choice_char_class() -> str:
    """Определяет и возвращает роль игрока."""
    approve_choice: str = ''
    char_class: str = ''
